...
export default function SpinRecord({ vinyls, trigger, onSpinStateChange }: SpinRecordProps) {
    ...
    return (
        <>
            {/* Modal */}
            {(selectedVinyl || showEmptyMessage) && (
                <div
                    ...
                    >
                        ...
                        {showEmptyMessage ? (
                            <div className="text-center py-8">
                                <h2 className="text-3xl font-bold mb-4">💽 Colección Vacía</h2>
                                <p className="text-muted-foreground mb-8 text-lg">
                                    Primero tienes que agregar mínimo 1 disco a la colección.
                                </p>
                                <Link
                                    href="/search"
                                    onClick={closeModal}
                                    className="inline-flex items-center gap-2 px-6 py-3 bg-primary text-black hover:bg-primary/90 rounded-lg transition-colors font-medium"
                                >
